...
global.channelLink = "https://whatsapp.com/channel/0029Vb5tHsD9sBI04k5Y860t";
global.ytch = "IsaacAchor";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb5tHsD9sBI04k5Y860t' 
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, { 
                    text: `🔗 *Support*\n\nhttps://whatsapp.com/channel/0029VbB1oIIC1FuDt6R1M52X` 
                }, { quoted: message });
                return;
            }
        }
